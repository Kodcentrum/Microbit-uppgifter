...
Om du aldrig har kodat en micro:bit förut är det bra om du först gör uppgiften [Uppvärmning](https://www.kodboken.se/start/skapa-spel/uppgifter-for-microbit/microbit-uppvarmning). Då får du lära dig lite enklare saker om hur  micro:biten fungerar och kan kodas.
